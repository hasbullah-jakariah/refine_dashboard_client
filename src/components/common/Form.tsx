...
const Form = ({type, handleSubmit,handleImageChange, onFinishHandler,formLoading,onFinish, propertyImage, register} : FormProps) => {
  return (
    <Box>
        ...
        >
            ...
            <Stack direction="row" gap={4}>
              <FormControl sx={{flex : 1}}>
                    ...
                    >
                        <MenuItem value="apartment">Apartement</MenuItem>
                        <MenuItem value="villa">Villa</MenuItem>
                        <MenuItem value="farmhouse">Farmhouse</MenuItem>
                        <MenuItem value="condos">Condos</MenuItem>
                        <MenuItem value="townhouse">Thownhouse</MenuItem>
              ...
              <FormControl>
                <FormHelperText sx={{fontWeight : 500, margin : "10px", fontSize : 16, color : "#11142d"}}>Enter  price</FormHelperText>
                <TextField 
                  fullWidth
                  required
                  id="outlined-basic"
            ...
            <Stack direction="column" gap={1} justifyContent="center" mb={2}>
                    ...
                    <Typography fontSize={14} color="#818191" sx={{wordbreak : 'break-all'}}>
                          {propertyImage?.name}
                    </Typography>
            </Stack>
            <CustomButton 
